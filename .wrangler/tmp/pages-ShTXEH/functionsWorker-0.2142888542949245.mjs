...
// ../.wrangler/tmp/bundle-iW2Fbo/checked-fetch.js
...
var todayKey = /* @__PURE__ */ __name(() => (/* @__PURE__ */ new Date()).toISOString().slice(0, 10), "todayKey");
var getBearerToken = /* @__PURE__ */ __name((request) => {
  const auth = request.headers.get("Authorization") || "";
  return auth.startsWith("Bearer ") ? auth.slice(7).trim() : "";
}, "getBearerToken");
var hasUsageConfig = /* @__PURE__ */ __name((env) => env.SUPABASE_URL && env.SUPABASE_ANON_KEY && env.SUPABASE_SERVICE_ROLE_KEY, "hasUsageConfig");
...
// api/billing.js
var jsonHeaders = /* @__PURE__ */ __name((request, env) => {
...
var jsonResponse = /* @__PURE__ */ __name((body, status, headers) => new Response(JSON.stringify(body), { status, headers }), "jsonResponse");
var normalizePlan = /* @__PURE__ */ __name((plan) => ["premium", "team"].includes(plan) ? plan : "premium", "normalizePlan");
...
var jsonHeaders2 = /* @__PURE__ */ __name((request, env) => {
  const origin = request.headers.get("Origin") || "";
  const selfOrigin = new URL(request.url).origin;
  const allowedOrigins = (env.ALLOWED_ORIGINS || selfOrigin).split(",").map((item) => item.trim()).filter(Boolean);
  const allowOrigin = allowedOrigins.includes(origin) ? origin : selfOrigin;
...
var jsonResponse2 = /* @__PURE__ */ __name((body, status, headers) => new Response(JSON.stringify(body), { status, headers }), "jsonResponse");
var cleanString = /* @__PURE__ */ __name((value) => String(value || "").trim(), "cleanString");
var getProviderConfig = /* @__PURE__ */ __name((providerName) => {
...
var resolveApiKey = /* @__PURE__ */ __name((provider, body, env) => {
...
var getMinutesLabels = /* @__PURE__ */ __name((minutesType) => {
...
var buildPrompt = /* @__PURE__ */ __name((transcript, question, mode, options = {}) => {
  if (question) {
    return `\uC790\uB9C9 \uB0B4\uC6A9:
${transcript}
...
// api/config.js
var jsonHeaders3 = /* @__PURE__ */ __name((request, env) => {
  const origin = request.headers.get("Origin") || "";
  const selfOrigin = new URL(request.url).origin;
  const allowedOrigins = (env.ALLOWED_ORIGINS || selfOrigin).split(",").map((item) => item.trim()).filter(Boolean);
  const allowOrigin = allowedOrigins.includes(origin) ? origin : selfOrigin;
...
var jsonHeaders4 = /* @__PURE__ */ __name((request, env) => {
  const origin = request.headers.get("Origin") || "";
  const selfOrigin = new URL(request.url).origin;
  const allowedOrigins = (env.ALLOWED_ORIGINS || selfOrigin).split(",").map((item) => item.trim()).filter(Boolean);
  const allowOrigin = allowedOrigins.includes(origin) ? origin : selfOrigin;
...
var jsonResponse3 = /* @__PURE__ */ __name((body, status, headers) => new Response(JSON.stringify(body), { status, headers }), "jsonResponse");
var cleanString2 = /* @__PURE__ */ __name((value) => String(value || "").trim(), "cleanString");
var sleep = /* @__PURE__ */ __name((ms) => new Promise((resolve) => setTimeout(resolve, ms)), "sleep");
var normalizeLanguage = /* @__PURE__ */ __name((language, provider) => {
...
var getProviderConfig2 = /* @__PURE__ */ __name((providerName) => {
  if (providerName === "default") return { provider: "groq", config: PROVIDERS2.groq };
  const config = PROVIDERS2[providerName];
  return config ? { provider: providerName, config } : null;
}, "getProviderConfig");
var resolveApiKey2 = /* @__PURE__ */ __name((provider, formData, env) => {
...
var speakerLabel = /* @__PURE__ */ __name((speaker) => {
...
var parseGladiaText = /* @__PURE__ */ __name((data, diarization = false) => {
...
// api/usage.js
var jsonHeaders5 = /* @__PURE__ */ __name((request, env) => {
  const origin = request.headers.get("Origin") || "";
  const selfOrigin = new URL(request.url).origin;
  const allowedOrigins = (env.ALLOWED_ORIGINS || selfOrigin).split(",").map((item) => item.trim()).filter(Boolean);
  const allowOrigin = allowedOrigins.includes(origin) ? origin : selfOrigin;
...
var jsonResponse4 = /* @__PURE__ */ __name((body, status, headers) => new Response(JSON.stringify(body), { status, headers }), "jsonResponse");
...
// ../.wrangler/tmp/pages-ShTXEH/functionsRoutes-0.6690377571077268.mjs
var routes = [
  {
...
// C:/Users/ckdwn/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// C:/Users/ckdwn/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../.wrangler/tmp/bundle-iW2Fbo/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-iW2Fbo/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.2142888542949245.mjs.map

...
document.addEventListener('fullscreenchange', () => {
    ...
    if (location.protocol === "file:") {
        log("번역?� ?�버 주소?�서 ?�행?????�용?????�습?�다. ?�문 ?�막???�시?�니??", true);
        return text;
    }
    ...
    try {
        ...
        log("번역 ?�막 ?�결 ?�류: 로컬 ?�일�??�었?�면 ?�버 주소?�서 ?�행??주세??", true);
        return source;
    } finally {
